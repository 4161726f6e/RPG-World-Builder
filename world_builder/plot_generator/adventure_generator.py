...
def genBasicPlot():
    ...
    # Roll for Themes
    myCSV = "plot_generator/basic_plot/themes.csv"
    roll = rollPE(myCSV)
    printRoll(roll, myCSV)

    # Roll for Goals
    myCSV = "plot_generator/basic_plot/goals.csv"
    roll = rollPE(myCSV)
    printRoll(roll, myCSV)

    # Roll for Story Hooks
    myCSV = "plot_generator/basic_plot/story_hooks.csv"
    roll = rollPE(myCSV)
    printRoll(roll, myCSV)

    # Roll for General Settings
    myCSV = "plot_generator/basic_plot/general_settings.csv"
    roll = rollPE(myCSV)
    printRoll(roll, myCSV)

    # Roll for Specific Settings
    myCSV = "plot_generator/basic_plot/specific_settings.csv"
    roll = rollPE(myCSV)
    printRoll(roll, myCSV)

    # Roll for Allies and Neutrals
    myCSV = "plot_generator/basic_plot/allies_and_neutrals.csv"
    roll = rollPE(myCSV)
    printRoll(roll, myCSV)

    # Roll for Master Villains
    myCSV = "plot_generator/basic_plot/master_villains.csv"
    roll = rollPE(myCSV)
    printRoll(roll, myCSV)

    # Roll for Minor Villains
    myCSV = "plot_generator/basic_plot/minor_villains.csv"
    roll = rollPE(myCSV)
    printRoll(roll, myCSV)

    # Roll for Plots
    myCSV = "plot_generator/basic_plot/plots.csv"
    roll = rollPE(myCSV)
    printRoll(roll, myCSV)

    # Roll for Climaxes
    myCSV = "plot_generator/basic_plot/climaxes.csv"
    roll = rollPE(myCSV)
    printRoll(roll, myCSV)
...
def genOptionalPlot():
    ...
    myCSV = "plot_generator/optional_plot/monster_encounters.csv"
    rollPE(myCSV)

    # Roll for Character Encounters
    myCSV = "plot_generator/optional_plot/character_encounters.csv"
    rollPE(myCSV)

    # Roll for Traps and Deathtraps
    myCSV = "plot_generator/optional_plot/traps_and_deathtraps.csv"
    rollPE(myCSV)

    # Roll for Special Conditions
    myCSV = "plot_generator/optional_plot/special_conditions.csv"
    rollPE(myCSV)

    # Roll for Red Herrings
    myCSV = "plot_generator/optional_plot/red_herrings.csv"
    rollPE(myCSV)

    # Roll for Omens and Prophecies
    myCSV = "plot_generator/optional_plot/omens_and_prophecies.csv"
    rollPE(myCSV)

    # Roll for Moral Quandaries
    myCSV = "plot_generator/optional_plot/moral_quandaries.csv"
    rollPE(myCSV)

    # Roll for Chases
    myCSV = "plot_generator/optional_plot/chases.csv"
    rollPE(myCSV)

    # Roll for Secret Weakness
    myCSV = "plot_generator/optional_plot/secret_weaknesses.csv"
    rollPE(myCSV)

    # Roll for Cruel Tricks and Complications
    myCSV = "plot_generator/optional_plot/cruel_tricks_and_complications.csv"
    rollPE(myCSV)
...
def rollPE(myCSV):
    ...
    if myCSV == "plot_generator/basic_plot/themes.csv":
    ...
    elif myCSV == "plot_generator/basic_plot/specific_settings.csv"\
        or myCSV == "plot_generator/basic_plot/minor_villains.csv":
